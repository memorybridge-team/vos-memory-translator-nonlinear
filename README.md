...
| dataset·난이도·baseline·metric 동결 | `In Progress` | [Benchmark protocol v1.0](docs/design/03_benchmark_protocol.md); DAVIS·MOSEv2 validation manifest/loader 완료, LVOS v2 loader 준비 완료·공식 Eval 데이터 검증 대기 |
